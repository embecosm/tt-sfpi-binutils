...
// (WIP) Not sure if we need this, as it all works with it commented out
//DECLARE_INSN(ttrocc_cs_alloc, MATCH_XTTROCC_CS_ALLOC, MASK_XTTROCC_CS_ALLOC)
//DECLARE_INSN(ttrocc_cs_dealloc, MATCH_XTTROCC_CS_DEALLOC, MASK_XTTROCC_CS_DEALLOC)
//DECLARE_INSN(ttrocc_cs_save, MATCH_XTTROCC_CS_SAVE, MASK_XTTROCC_CS_SAVE)
//DECLARE_INSN(ttrocc_cs_restore, MATCH_XTTROCC_CS_RESTORE, MASK_XTTROCC_CS_RESTORE)
//DECLARE_INSN(ttrocc_addrgen_wr_reg, MATCH_XTTROCC_ADDRGEN_WR_REG, MASK_XTTROCC_ADDRGEN_WR_REG)
