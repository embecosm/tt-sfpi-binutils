...
#define MASK_XTTROCC_CS_ALLOC MASK_XTTROCC_GENERIC
#define MATCH_XTTROCC_CS_ALLOC 0x600405B
#define MASK_XTTROCC_CS_DEALLOC MASK_XTTROCC_GENERIC
#define MATCH_XTTROCC_CS_DEALLOC 0x400205B
#define MASK_XTTROCC_CS_SAVE MASK_XTTROCC_GENERIC
#define MATCH_XTTROCC_CS_SAVE 0x200205B
#define MASK_XTTROCC_CS_RESTORE MASK_XTTROCC_GENERIC
...
DECLARE_INSN(ttroc_cs_alloc, MATCH_XTTROCC_CS_ALLOC, MASK_XTTROCC_CS_ALLOC)
DECLARE_INSN(ttroc_cs_dealloc, MATCH_XTTROCC_CS_DEALLOC, MASK_XTTROCC_CS_DEALLOC)
DECLARE_INSN(ttroc_cs_save, MATCH_XTTROCC_CS_SAVE, MASK_XTTROCC_CS_SAVE)
DECLARE_INSN(ttroc_cs_restore, MATCH_XTTROCC_CS_RESTORE, MASK_XTTROCC_CS_RESTORE)
