...
{"th.vmsge.vx",   0, INSN_CLASS_XTHEADVECTOR, "Vd,Vt,sVm", 0, (int) M_VMSGE, NULL, INSN_MACRO },
{"th.vmsge.vx",   0, INSN_CLASS_XTHEADVECTOR, "Vd,Vt,s,VM,VT", 0, (int) M_VMSGE, NULL, INSN_MACRO },
{"th.vmsgeu.vx",  0, INSN_CLASS_XTHEADVECTOR, "Vd,Vt,sVm", 1, (int) M_VMSGE, NULL, INSN_MACRO },
{"th.vmsgeu.vx",  0, INSN_CLASS_XTHEADVECTOR, "Vd,Vt,s,VM,VT", 1, (int) M_VMSGE, NULL, INSN_MACRO },
...
{"tt.rocc.wr_tiles_to_process_thres_tr_ack",      0, INSN_CLASS_XTTROCC, "s,t", MATCH_TTROCC_WR_TILES_TO_PROCESS_THRES_TR_ACK, MASK_TTROCC_WR_TILES_TO_PROCESS_THRES_TR_ACK, match_opcode, 0},
{"tt.rocc.wr_tiles_to_process_thres_wr_sent",     0, INSN_CLASS_XTTROCC, "s,t", MATCH_TTROCC_WR_TILES_TO_PROCESS_THRES_WR_SENT, MASK_TTROCC_WR_TILES_TO_PROCESS_THRES_WR_SENT, match_opcode, 0},
{"tt.rocc.wr_tiles_to_process_thres_idma_tr_ack", 0, INSN_CLASS_XTTROCC, "s,t", MATCH_TTROCC_WR_TILES_TO_PROCESS_THRES_IDMA_TR_ACK, MASK_TTROCC_WR_TILES_TO_PROCESS_THRES_IDMA_TR_ACK, match_opcode, 0},
{"tt.rocc.rd_tiles_to_process_thres_tr_ack",      0, INSN_CLASS_XTTROCC, "d,s", MATCH_TTROCC_RD_TILES_TO_PROCESS_THRES_TR_ACK, MASK_TTROCC_RD_TILES_TO_PROCESS_THRES_TR_ACK, match_opcode, 0},
{"tt.rocc.rd_tiles_to_process_thres_wr_sent",     0, INSN_CLASS_XTTROCC, "d,s", MATCH_TTROCC_RD_TILES_TO_PROCESS_THRES_WR_SENT, MASK_TTROCC_RD_TILES_TO_PROCESS_THRES_WR_SENT, match_opcode, 0},
{"tt.rocc.rd_tiles_to_process_thres_idma_tr_ack", 0, INSN_CLASS_XTTROCC, "d,s", MATCH_TTROCC_RD_TILES_TO_PROCESS_THRES_IDMA_TR_ACK, MASK_TTROCC_RD_TILES_TO_PROCESS_THRES_IDMA_TR_ACK, match_opcode, 0},
{"tt.rocc.scmdbuf_get_vc_space",	    0, INSN_CLASS_XTTROCC, "d", MATCH_TTROCC_SCMDBUF_GET_VC_SPACE, MASK_TTROCC_SCMDBUF_GET_VC_SPACE, match_opcode, 0},
{"tt.rocc.scmdbuf_get_vc_space_vc",	    0, INSN_CLASS_XTTROCC, "d,s", MATCH_TTROCC_SCMDBUF_GET_VC_SPACE_VC, MASK_TTROCC_SCMDBUF_GET_VC_SPACE_VC, match_opcode, 0},
{"tt.rocc.scmdbuf_wr_sent",		    0, INSN_CLASS_XTTROCC, "d", MATCH_TTROCC_SCMDBUF_WR_SENT, MASK_TTROCC_SCMDBUF_WR_SENT, match_opcode, 0},
{"tt.rocc.scmdbuf_wr_sent_trid",	    0, INSN_CLASS_XTTROCC, "d,s", MATCH_TTROCC_SCMDBUF_WR_SENT_TRID, MASK_TTROCC_SCMDBUF_WR_SENT_TRID, match_opcode, 0},
{"tt.rocc.scmdbuf_tr_ack",		    0, INSN_CLASS_XTTROCC, "d", MATCH_TTROCC_SCMDBUF_TR_ACK, MASK_TTROCC_SCMDBUF_TR_ACK, match_opcode, 0},
{"tt.rocc.scmdbuf_tr_ack_trid",		    0, INSN_CLASS_XTTROCC, "d,s", MATCH_TTROCC_SCMDBUF_TR_ACK_TRID, MASK_TTROCC_SCMDBUF_TR_ACK_TRID, match_opcode, 0},
{"tt.rocc.scmdbuf_reset",		    0, INSN_CLASS_XTTROCC, "", MATCH_TTROCC_SCMDBUF_RESET, MASK_TTROCC_SCMDBUF_RESET, match_opcode, 0},
{"tt.rocc.scmdbuf_issue_trans",		    0, INSN_CLASS_XTTROCC, "", MATCH_TTROCC_SCMDBUF_ISSUE_TRANS, MASK_TTROCC_SCMDBUF_ISSUE_TRANS, match_opcode, 0},
{"tt.rocc.scmdbuf_issue_inline_trans",	    0, INSN_CLASS_XTTROCC, "s", MATCH_TTROCC_SCMDBUF_ISSUE_INLINE_TRANS, MASK_TTROCC_SCMDBUF_ISSUE_INLINE_TRANS, match_opcode, 0},
{"tt.rocc.scmdbuf_issue_inline_addr_trans", 0, INSN_CLASS_XTTROCC, "s,t", MATCH_TTROCC_SCMDBUF_ISSUE_INLINE_ADDR_TRANS, MASK_TTROCC_SCMDBUF_ISSUE_INLINE_ADDR_TRANS, match_opcode, 0},
...
{"tt.rocc.scmdbuf_issue_read2_trans",	    0, INSN_CLASS_XTTROCC, "s,t", MATCH_TTROCC_SCMDBUF_ISSUE_READ2_TRANS, MASK_TTROCC_SCMDBUF_ISSUE_READ2_TRANS, match_opcode, 0},
...
{"tt.rocc.scmdbuf_read_tiles_to_process_tr_ack",            0, INSN_CLASS_XTTROCC, "d", MATCH_TTROCC_SCMDBUF_READ_TILES_TO_PROCESS_TR_ACK, MASK_TTROCC_SCMDBUF_READ_TILES_TO_PROCESS_TR_ACK, match_opcode, 0},
{"tt.rocc.scmdbuf_read_tiles_to_process_tr_ack_tr_id",      0, INSN_CLASS_XTTROCC, "d,s", MATCH_TTROCC_SCMDBUF_READ_TILES_TO_PROCESS_TR_ACK_TR_ID, MASK_TTROCC_SCMDBUF_READ_TILES_TO_PROCESS_TR_ACK_TR_ID, match_opcode, 0},
{"tt.rocc.scmdbuf_read_tiles_to_process_wr_sent",           0, INSN_CLASS_XTTROCC, "d", MATCH_TTROCC_SCMDBUF_READ_TILES_TO_PROCESS_WR_SENT, MASK_TTROCC_SCMDBUF_READ_TILES_TO_PROCESS_WR_SENT, match_opcode, 0},
{"tt.rocc.scmdbuf_read_tiles_to_process_wr_sent_tr_id",     0, INSN_CLASS_XTTROCC, "d,s", MATCH_TTROCC_SCMDBUF_READ_TILES_TO_PROCESS_WR_SENT_TR_ID, MASK_TTROCC_SCMDBUF_READ_TILES_TO_PROCESS_WR_SENT_TR_ID, match_opcode, 0},
{"tt.rocc.scmdbuf_read_tiles_to_process_idma_tr_ack",       0, INSN_CLASS_XTTROCC, "d", MATCH_TTROCC_SCMDBUF_READ_TILES_TO_PROCESS_IDMA_TR_ACK, MASK_TTROCC_SCMDBUF_READ_TILES_TO_PROCESS_IDMA_TR_ACK, match_opcode, 0},
{"tt.rocc.scmdbuf_read_tiles_to_process_idma_tr_ack_tr_id", 0, INSN_CLASS_XTTROCC, "d,s", MATCH_TTROCC_SCMDBUF_READ_TILES_TO_PROCESS_IDMA_TR_ACK_TR_ID, MASK_TTROCC_SCMDBUF_READ_TILES_TO_PROCESS_IDMA_TR_ACK_TR_ID, match_opcode, 0},
{"tt.rocc.scmdbuf_clear_tiles_to_process_tr_ack",           0, INSN_CLASS_XTTROCC, "s", MATCH_TTROCC_SCMDBUF_CLEAR_TILES_TO_PROCESS_TR_ACK, MASK_TTROCC_SCMDBUF_CLEAR_TILES_TO_PROCESS_TR_ACK, match_opcode, 0},
{"tt.rocc.scmdbuf_clear_tiles_to_process_wr_sent",          0, INSN_CLASS_XTTROCC, "s", MATCH_TTROCC_SCMDBUF_CLEAR_TILES_TO_PROCESS_WR_SENT, MASK_TTROCC_SCMDBUF_CLEAR_TILES_TO_PROCESS_WR_SENT, match_opcode, 0},
{"tt.rocc.scmdbuf_clear_tiles_to_process_idma_tr_ack",      0, INSN_CLASS_XTTROCC, "s", MATCH_TTROCC_SCMDBUF_CLEAR_TILES_TO_PROCESS_IDMA_TR_ACK, MASK_TTROCC_SCMDBUF_CLEAR_TILES_TO_PROCESS_IDMA_TR_ACK, match_opcode, 0},
{"tt.rocc.scmdbuf_wr_reg",		    0, INSN_CLASS_XTTROCC, "d,J25l49,s,t", MATCH_TTROCC_SCMDBUF_WR_REG, MASK_TTROCC_SCMDBUF_WR_REG, match_opcode, 0},
{"tt.rocc.scmdbuf_rd_reg",		    0, INSN_CLASS_XTTROCC, "d,J25l49,s,t", MATCH_TTROCC_SCMDBUF_RD_REG, MASK_TTROCC_SCMDBUF_RD_REG, match_opcode, 0},
{"tt.rocc.addrgen_reset",                   0, INSN_CLASS_XTTROCC, "J30u1", MATCH_TTROCC_ADDRGEN_RESET, MASK_TTROCC_ADDRGEN_RESET, match_opcode, 0},
{"tt.rocc.addrgen_reset_counters",          0, INSN_CLASS_XTTROCC, "J30u1,s", MATCH_TTROCC_ADDRGEN_RESET_COUNTERS, MASK_TTROCC_ADDRGEN_RESET_COUNTERS, match_opcode, 0},
{"tt.rocc.addrgen_pop_dest",                0, INSN_CLASS_XTTROCC, "d,J30u1", MATCH_TTROCC_ADDRGEN_POP_DEST, MASK_TTROCC_ADDRGEN_POP_DEST, match_opcode, 0},
{"tt.rocc.addrgen_pop_x_dest",              0, INSN_CLASS_XTTROCC, "d,J30u1,s", MATCH_TTROCC_ADDRGEN_POP_X_DEST, MASK_TTROCC_ADDRGEN_POP_X_DEST, match_opcode, 0},
{"tt.rocc.addrgen_peek_dest",               0, INSN_CLASS_XTTROCC, "d,J30u1", MATCH_TTROCC_ADDRGEN_PEEK_DEST, MASK_TTROCC_ADDRGEN_PEEK_DEST, match_opcode, 0},
{"tt.rocc.addrgen_peek_src",                0, INSN_CLASS_XTTROCC, "d,J30u1", MATCH_TTROCC_ADDRGEN_PEEK_SRC, MASK_TTROCC_ADDRGEN_PEEK_SRC, match_opcode, 0},
{"tt.rocc.addrgen_pop_src",                 0, INSN_CLASS_XTTROCC, "d,J30u1", MATCH_TTROCC_ADDRGEN_POP_SRC, MASK_TTROCC_ADDRGEN_POP_SRC, match_opcode, 0},
{"tt.rocc.addrgen_pop_x_src",               0, INSN_CLASS_XTTROCC, "d,J30u1,s", MATCH_TTROCC_ADDRGEN_POP_X_SRC, MASK_TTROCC_ADDRGEN_POP_X_SRC, match_opcode, 0},
{"tt.rocc.addrgen_pop_both",                0, INSN_CLASS_XTTROCC, "d,J30u1,s,t", MATCH_TTROCC_ADDRGEN_POP_BOTH, MASK_TTROCC_ADDRGEN_POP_BOTH, match_opcode, 0},
{"tt.rocc.addrgen_push_src",                0, INSN_CLASS_XTTROCC, "J30u1", MATCH_TTROCC_ADDRGEN_PUSH_SRC, MASK_TTROCC_ADDRGEN_PUSH_SRC, match_opcode, 0},
{"tt.rocc.addrgen_push_src_pop_x",          0, INSN_CLASS_XTTROCC, "J30u1,s", MATCH_TTROCC_ADDRGEN_PUSH_SRC_POP_X, MASK_TTROCC_ADDRGEN_PUSH_SRC_POP_X, match_opcode, 0},
{"tt.rocc.addrgen_push_dest",               0, INSN_CLASS_XTTROCC, "J30u1", MATCH_TTROCC_ADDRGEN_PUSH_DEST, MASK_TTROCC_ADDRGEN_PUSH_DEST, match_opcode, 0},
{"tt.rocc.addrgen_push_dest_pop_x",         0, INSN_CLASS_XTTROCC, "J30u1,s", MATCH_TTROCC_ADDRGEN_PUSH_DEST_POP_X, MASK_TTROCC_ADDRGEN_PUSH_DEST_POP_X, match_opcode, 0},
{"tt.rocc.addrgen_push_both",               0, INSN_CLASS_XTTROCC, "J30u1", MATCH_TTROCC_ADDRGEN_PUSH_BOTH, MASK_TTROCC_ADDRGEN_PUSH_BOTH, match_opcode, 0},
{"tt.rocc.addrgen_push_both_pop_x",         0, INSN_CLASS_XTTROCC, "J30u1,s,t", MATCH_TTROCC_ADDRGEN_PUSH_BOTH_POP_X, MASK_TTROCC_ADDRGEN_PUSH_BOTH_POP_X, match_opcode, 0},
{"tt.rocc.addrgen_wr_reg",                  0, INSN_CLASS_XTTROCC, "d,J30u1,J25l25,s,t", MATCH_TTROCC_ADDRGEN_WR_REG, MASK_TTROCC_ADDRGEN_WR_REG, match_opcode, 0},
{"tt.rocc.addrgen_rd_reg",                  0, INSN_CLASS_XTTROCC, "d,J30u1,J25l25,s,t", MATCH_TTROCC_ADDRGEN_RD_REG, MASK_TTROCC_ADDRGEN_RD_REG, match_opcode, 0},
{"tt.rocc.cmdbuf_issue_write2_trans",       0, INSN_CLASS_XTTROCC, "J31u1,s,t", MATCH_TTROCC_CMDBUF_ISSUE_WRITE2_TRANS, MASK_TTROCC_CMDBUF_ISSUE_WRITE2_TRANS, match_opcode, 0},
...
{"tt.rocc.cmdbuf_idma_tr_ack",	            0, INSN_CLASS_XTTROCC, "d,J31u1", MATCH_TTROCC_CMDBUF_IDMA_TR_ACK, MASK_TTROCC_CMDBUF_IDMA_TR_ACK, match_opcode, 0},
{"tt.rocc.cmdbuf_idma_get_vc_space_vc",     0, INSN_CLASS_XTTROCC, "d,J31u1,s", MATCH_TTROCC_CMDBUF_IDMA_GET_VC_SPACE_VC, MASK_TTROCC_CMDBUF_IDMA_GET_VC_SPACE_VC, match_opcode, 0},
{"tt.rocc.cmdbuf_idma_get_vc_space",	    0, INSN_CLASS_XTTROCC, "d,J31u1", MATCH_TTROCC_CMDBUF_IDMA_GET_VC_SPACE, MASK_TTROCC_CMDBUF_IDMA_GET_VC_SPACE, match_opcode, 0},
{"tt.rocc.cmdbuf_reset",		    0, INSN_CLASS_XTTROCC, "J31u1", MATCH_TTROCC_CMDBUF_RESET, MASK_TTROCC_CMDBUF_RESET, match_opcode, 0},
{"tt.rocc.cmdbuf_tr_ack_trid",	      	    0, INSN_CLASS_XTTROCC, "d,J31u1,s", MATCH_TTROCC_CMDBUF_TR_ACK_TRID, MASK_TTROCC_CMDBUF_TR_ACK_TRID, match_opcode, 0},
{"tt.rocc.cmdbuf_tr_ack",	      	    0, INSN_CLASS_XTTROCC, "d,J31u1", MATCH_TTROCC_CMDBUF_TR_ACK, MASK_TTROCC_CMDBUF_TR_ACK, match_opcode, 0},
{"tt.rocc.cmdbuf_wr_sent_trid",	      	    0, INSN_CLASS_XTTROCC, "d,J31u1,s", MATCH_TTROCC_CMDBUF_WR_SENT_TRID, MASK_TTROCC_CMDBUF_WR_SENT_TRID, match_opcode, 0},
{"tt.rocc.cmdbuf_get_vc_space",	      	    0, INSN_CLASS_XTTROCC, "d,J31u1", MATCH_TTROCC_CMDBUF_GET_VC_SPACE, MASK_TTROCC_CMDBUF_GET_VC_SPACE, match_opcode, 0},
{"tt.rocc.cmdbuf_get_vc_space_vc",     	    0, INSN_CLASS_XTTROCC, "d,J31u1,s", MATCH_TTROCC_CMDBUF_GET_VC_SPACE_VC, MASK_TTROCC_CMDBUF_GET_VC_SPACE_VC, match_opcode, 0},
{"tt.rocc.cmdbuf_wr_sent",	      	    0, INSN_CLASS_XTTROCC, "d,J31u1", MATCH_TTROCC_CMDBUF_WR_SENT, MASK_TTROCC_CMDBUF_WR_SENT, match_opcode, 0},
{"tt.rocc.cmdbuf_read_tiles_to_process_tr_ack",             0, INSN_CLASS_XTTROCC, "d,J31u1", MATCH_TTROCC_CMDBUF_READ_TILES_TO_PROCESS_TR_ACK, MASK_TTROCC_CMDBUF_READ_TILES_TO_PROCESS_TR_ACK, match_opcode, 0},
{"tt.rocc.cmdbuf_read_tiles_to_process_tr_ack_tr_id",       0, INSN_CLASS_XTTROCC, "d,J31u1,s", MATCH_TTROCC_CMDBUF_READ_TILES_TO_PROCESS_TR_ACK_TR_ID, MASK_TTROCC_CMDBUF_READ_TILES_TO_PROCESS_TR_ACK_TR_ID, match_opcode, 0},
{"tt.rocc.cmdbuf_read_tiles_to_process_wr_sent",            0, INSN_CLASS_XTTROCC, "d,J31u1", MATCH_TTROCC_CMDBUF_READ_TILES_TO_PROCESS_WR_SENT, MASK_TTROCC_CMDBUF_READ_TILES_TO_PROCESS_WR_SENT, match_opcode, 0},
{"tt.rocc.cmdbuf_read_tiles_to_process_wr_sent_tr_id",      0, INSN_CLASS_XTTROCC, "d,J31u1,s", MATCH_TTROCC_CMDBUF_READ_TILES_TO_PROCESS_WR_SENT_TR_ID, MASK_TTROCC_CMDBUF_READ_TILES_TO_PROCESS_WR_SENT_TR_ID, match_opcode, 0},
{"tt.rocc.cmdbuf_read_tiles_to_process_idma_tr_ack",        0, INSN_CLASS_XTTROCC, "d,J31u1", MATCH_TTROCC_CMDBUF_READ_TILES_TO_PROCESS_IDMA_TR_ACK, MASK_TTROCC_CMDBUF_READ_TILES_TO_PROCESS_IDMA_TR_ACK, match_opcode, 0},
{"tt.rocc.cmdbuf_read_tiles_to_process_idma_tr_ack_tr_id",  0, INSN_CLASS_XTTROCC, "d,J31u1,s", MATCH_TTROCC_CMDBUF_READ_TILES_TO_PROCESS_IDMA_TR_ACK_TR_ID, MASK_TTROCC_CMDBUF_READ_TILES_TO_PROCESS_IDMA_TR_ACK_TR_ID, match_opcode, 0},
{"tt.rocc.cmdbuf_clear_tiles_to_process_tr_ack",            0, INSN_CLASS_XTTROCC, "J31u1,s", MATCH_TTROCC_CMDBUF_CLEAR_TILES_TO_PROCESS_TR_ACK, MASK_TTROCC_CMDBUF_CLEAR_TILES_TO_PROCESS_TR_ACK, match_opcode, 0},
{"tt.rocc.cmdbuf_clear_tiles_to_process_wr_sent",           0, INSN_CLASS_XTTROCC, "J31u1,s", MATCH_TTROCC_CMDBUF_CLEAR_TILES_TO_PROCESS_WR_SENT, MASK_TTROCC_CMDBUF_CLEAR_TILES_TO_PROCESS_WR_SENT, match_opcode, 0},
{"tt.rocc.cmdbuf_clear_tiles_to_process_idma_tr_ack",       0, INSN_CLASS_XTTROCC, "J31u1,s", MATCH_TTROCC_CMDBUF_CLEAR_TILES_TO_PROCESS_IDMA_TR_ACK, MASK_TTROCC_CMDBUF_CLEAR_TILES_TO_PROCESS_IDMA_TR_ACK, match_opcode, 0},
{"tt.rocc.cmdbuf_wr_reg",	      	    0, INSN_CLASS_XTTROCC, "d,J31u1,J25l49,s,t", MATCH_TTROCC_CMDBUF_WR_REG, MASK_TTROCC_CMDBUF_WR_REG, match_opcode, 0},
{"tt.rocc.cmdbuf_rd_reg",	      	    0, INSN_CLASS_XTTROCC, "d,J31u1,J25l49,s,t", MATCH_TTROCC_CMDBUF_RD_REG, MASK_TTROCC_CMDBUF_RD_REG, match_opcode, 0},
