...
{"tt.rocc.scmdbuf_wr_reg",		    0, INSN_CLASS_XTTROCC, "d,Jxd1,s,t", MATCH_TTROCC_SCMDBUF_WR_REG, MASK_TTROCC_SCMDBUF_WR_REG, match_opcode, 0},
{"tt.rocc.scmdbuf_rd_reg",		    0, INSN_CLASS_XTTROCC, "d,Jxd1,s,t", MATCH_TTROCC_SCMDBUF_RD_REG, MASK_TTROCC_SCMDBUF_RD_REG, match_opcode, 0},
...
{"tt.rocc.addrgen_pop_both",                0, INSN_CLASS_XTTROCC, "d,Jxd2,s,t", MATCH_TTROCC_ADDRGEN_POP_BOTH, MASK_TTROCC_ADDRGEN_POP_BOTH, match_opcode, 0},
{"tt.rocc.addrgen_push_src",                0, INSN_CLASS_XTTROCC, "Jxd2", MATCH_TTROCC_ADDRGEN_PUSH_SRC, MASK_TTROCC_ADDRGEN_PUSH_SRC, match_opcode, 0},
{"tt.rocc.addrgen_push_src_pop_x",          0, INSN_CLASS_XTTROCC, "Jxd2,s", MATCH_TTROCC_ADDRGEN_PUSH_SRC_POP_X, MASK_TTROCC_ADDRGEN_PUSH_SRC_POP_X, match_opcode, 0},
{"tt.rocc.addrgen_push_dest",               0, INSN_CLASS_XTTROCC, "Jxd2", MATCH_TTROCC_ADDRGEN_PUSH_DEST, MASK_TTROCC_ADDRGEN_PUSH_DEST, match_opcode, 0},
{"tt.rocc.addrgen_push_dest_pop_x",         0, INSN_CLASS_XTTROCC, "Jxd2,s", MATCH_TTROCC_ADDRGEN_PUSH_DEST_POP_X, MASK_TTROCC_ADDRGEN_PUSH_DEST_POP_X, match_opcode, 0},
{"tt.rocc.addrgen_push_both",               0, INSN_CLASS_XTTROCC, "Jxd2", MATCH_TTROCC_ADDRGEN_PUSH_BOTH, MASK_TTROCC_ADDRGEN_PUSH_BOTH, match_opcode, 0},
{"tt.rocc.addrgen_push_both_pop_x",         0, INSN_CLASS_XTTROCC, "Jxd2,s,t", MATCH_TTROCC_ADDRGEN_PUSH_BOTH_POP_X, MASK_TTROCC_ADDRGEN_PUSH_BOTH_POP_X, match_opcode, 0},
